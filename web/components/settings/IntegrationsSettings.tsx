...
export function IntegrationsSettings({ workspaceId, initialIntegrations }: IntegrationsSettingsProps) {
    ...
    return (
        <div className="space-y-6">
            ...
            {/* Slack & Discord Cards - Side by Side */}
